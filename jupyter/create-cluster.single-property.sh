...
gcloud beta dataproc clusters create ${DATAPROC_CLUSTER_NAME} \
  ...
  --properties=^#^spark:spark.jars.packages='org.apache.spark:spark-tags_2.11:2.4.0','org.apache.spark:spark-mllib_2.11:2.4.0','ml.combust.mleap:mleap-base_2.12:0.10.0','ml.combust.mleap:mleap-core_2.12:0.10.0','ml.combust.mleap:mleap-runtime_2.12:0.10.0','ml.combust.mleap:mleap-spark_2.12:0.10.0','ml.combust.mleap:mleap-spark-base_2.12:0.10.0','ml.combust.mleap:mleap-spark-extension_2.12:0.10.0','ml.combust.mleap:mleap-tensor_2.12:0.10.0','com.databricks:spark-avro_2.11:4.0.0'